...
<pre><code class="json">{
    ...
    <li>If you find a bug or would like an improvement to the API, please <a href="https://github.com/pascalchevrel/stores_l10n/issues">file an issue on Github</a>.</li>
</ol>
